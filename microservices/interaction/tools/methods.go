...
func MapinternalInfoByString(result map[string]string) *generated.internalInfo {
	converted := make(map[string]interface{})
	// 将 map[string]string 转换为 map[string]interface{}
	for key, value := range result {
		converted[key] = value
	}
	return MapinternalInfo(converted)
}

func MapinternalInfo(result map[string]interface{}) *generated.internalInfo {
	statusStr := result["status"].(string)

	status := generated.internalStatus(generated.internalStatus_value[statusStr])
	...
	return &generated.internalInfo{
		internal: &generated.internal{
			BaseInfo: &generated.internalUpload{
				AuthorId:   authorId,
		...
		internalEngagement: &generated.internalEngagement{
			Views:       int32(views),
			Likes:       int32(likes),
			Saves:       int32(saves),
