...
var (
	ExchangesConfig = map[string]string{
		EXCHANGE_REGISTER:           "direct",
		EXCHANGE_STORE_USER:         "direct",
		EXCHANGE_STORE_CREDENTIAL:   "direct",
		EXCHANGE_UPDATE_USER_SPACE:  "direct",
		EXCHANGE_UPDATE_USER_BIO:    "direct",
		EXCHANGE_UPDATE_USER_AVATAR: "direct",
		EXCHANGE_FOLLOW:             "direct",
		EXCHANGE_CANCEL_FOLLOW:      "direct",
		EXCHANGE_UPDATE_USER_STATUS: "direct",
		EXCHANGE_DEL_REVIEWER:       "direct",
	}
)
