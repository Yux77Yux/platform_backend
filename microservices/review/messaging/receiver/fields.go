...
var (
	ExchangesConfig = map[string]string{
		EXCHANGE_COMMENT_REVIEW:  "direct",
		EXCHANGE_USER_REVIEW:     "direct",
		EXCHANGE_CREATION_REVIEW: "direct",
		EXCHANGE_NEW_REVIEW:      "direct",
		EXCHANGE_UPDATE:          "direct",
		EXCHANGE_BATCH_UPDATE:    "direct",
		EXCHANGE_PEND_CREATION:   "direct",
	}
)
