...
func TestGetReviews(t *testing.T) {
	...
	for {
		...
		r_response, err := api.GetReviews(_ctx, &review.GetReviewsRequest{
			Type:       review.TargetType_CREATION,
			Status:     review.ReviewStatus_PENDING,
...
func TestGetNewReviews(t *testing.T) {
	reviewerId := int64(1901557963315744768)
	refreshToken := &auth.RefreshToken{
		Value: Token,
	}
