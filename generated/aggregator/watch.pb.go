...
type InitialSecondCommentsRequest struct {
	...
	Request *comment.InitialSecondCommentsRequest `protobuf:"bytes,1,opt,name=request,proto3" json:"request,omitempty"`
}
...
func (x *InitialSecondCommentsRequest) GetRequest() *comment.InitialSecondCommentsRequest {
	if x != nil {
		return x.Request
	}
	return nil
...
func (x *InitialSecondCommentsResponse) GetComments() []*CommentInfo {
	if x != nil {
		return x.Comments
	}
	return nil
...
var file_aggregator_methods_watch_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x22, 0xd0, 0x01, 0x0a, 0x17, 0x49, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x6c, 0x43, 0x6f,
	...
	0x0a, 0x03, 0x6d, 0x73, 0x67, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x63, 0x6f,
	0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x41, 0x70, 0x69, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x52, 0x03, 0x6d, 0x73, 0x67, 0x22, 0x67, 0x0a, 0x1c, 0x49, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x6c,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2d, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74,
	0x2e, 0x6d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x73, 0x2e, 0x49, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x6c,
	0x53, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x43, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x52, 0x65,
	0x71, 0x75, 0x65, 0x73, 0x74, 0x52, 0x07, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x22, 0xa3,
	0x01, 0x0a, 0x1d, 0x49, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x6c, 0x53, 0x65, 0x63, 0x6f, 0x6e, 0x64,
	...
	0x49, 0x6e, 0x66, 0x6f, 0x52, 0x08, 0x63, 0x6f, 0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x12, 0x1d,
	...
	0x03, 0x6d, 0x73, 0x67, 0x22, 0x59, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x54, 0x6f, 0x70, 0x43, 0x6f,
	0x6d, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x40, 0x0a,
	...
	0x97, 0x01, 0x0a, 0x18, 0x47, 0x65, 0x74, 0x53, 0x65, 0x63, 0x6f, 0x6e, 0x64, 0x43, 0x6f, 0x6d,
	0x6d, 0x65, 0x6e, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x43, 0x0a, 0x07,
	...
	0x74, 0x12, 0x36, 0x0a, 0x0c, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x5f, 0x74, 0x6f, 0x6b, 0x65,
	...
	0x63, 0x65, 0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x95, 0x01, 0x0a, 0x17, 0x47, 0x65,
...
var file_aggregator_methods_watch_proto_goTypes = []any{
	...
	(*InitialSecondCommentsResponse)(nil),        // 5: aggregator.methods.InitialSecondCommentsResponse
	(*GetTopCommentsRequest)(nil),                // 6: aggregator.methods.GetTopCommentsRequest
	(*GetSecondCommentsRequest)(nil),             // 7: aggregator.methods.GetSecondCommentsRequest
	...
	(*CommentInfo)(nil),                          // 14: aggregator.messages.CommentInfo
	(*comment.CommentArea)(nil),                  // 15: comment.messages.CommentArea
	(*comment.InitialSecondCommentsRequest)(nil), // 16: comment.methods.InitialSecondCommentsRequest
	(*comment.GetTopCommentsRequest)(nil),        // 17: comment.methods.GetTopCommentsRequest
	(*comment.GetSecondCommentsRequest)(nil),     // 18: comment.methods.GetSecondCommentsRequest
	(*common.AccessToken)(nil),                   // 19: common.AccessToken
...
var file_aggregator_methods_watch_proto_depIdxs = []int32{
	...
	14, // 4: aggregator.methods.InitialCommentsResponse.comments:type_name -> aggregator.messages.CommentInfo
	...
	16, // 7: aggregator.methods.InitialSecondCommentsRequest.request:type_name -> comment.methods.InitialSecondCommentsRequest
	14, // 8: aggregator.methods.InitialSecondCommentsResponse.comments:type_name -> aggregator.messages.CommentInfo
	10, // 9: aggregator.methods.InitialSecondCommentsResponse.msg:type_name -> common.ApiResponse
	17, // 10: aggregator.methods.GetTopCommentsRequest.request:type_name -> comment.methods.GetTopCommentsRequest
	18, // 11: aggregator.methods.GetSecondCommentsRequest.request:type_name -> comment.methods.GetSecondCommentsRequest
	19, // 12: aggregator.methods.GetSecondCommentsRequest.access_token:type_name -> common.AccessToken
	20, // 13: aggregator.methods.GetReplyCommentsRequest.request:type_name -> comment.methods.GetReplyCommentsRequest
	19, // 14: aggregator.methods.GetReplyCommentsRequest.access_token:type_name -> common.AccessToken
	14, // 15: aggregator.methods.GetCommentsResponse.comments:type_name -> aggregator.messages.CommentInfo
	10, // 16: aggregator.methods.GetCommentsResponse.msg:type_name -> common.ApiResponse
