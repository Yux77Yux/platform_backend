...
type SimilarCreationsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SimilarCreationsRequest) Reset() {
	*x = SimilarCreationsRequest{}
	mi := &file_aggregator_methods_get_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SimilarCreationsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SimilarCreationsRequest) ProtoMessage() {}

func (x *SimilarCreationsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_aggregator_methods_get_proto_msgTypes[3]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SimilarCreationsRequest.ProtoReflect.Descriptor instead.
func (*SimilarCreationsRequest) Descriptor() ([]byte, []int) {
	return file_aggregator_methods_get_proto_rawDescGZIP(), []int{3}
}

func (x *SimilarCreationsRequest) GetCreationId() int64 {
	if x != nil {
		return x.CreationId
	}
	return 0
...
func (x *GetCardsResponse) Reset() {
	*x = GetCardsResponse{}
	mi := &file_aggregator_methods_get_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetCardsResponse) Descriptor() ([]byte, []int) {
	return file_aggregator_methods_get_proto_rawDescGZIP(), []int{4}
}
...
var file_aggregator_methods_get_proto_rawDesc = []byte{
	...
	0x28, 0x05, 0x52, 0x04, 0x70, 0x61, 0x67, 0x65, 0x22, 0x3a, 0x0a, 0x17, 0x53, 0x69, 0x6d, 0x69,
	0x6c, 0x61, 0x72, 0x43, 0x72, 0x65, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x65, 0x71, 0x75,
	...
	0x6f, 0x6e, 0x49, 0x64, 0x22, 0x72, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x43, 0x61, 0x72, 0x64, 0x73,
