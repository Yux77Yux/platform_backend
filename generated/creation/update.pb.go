...
var file_creation_methods_update_proto_rawDesc = []byte{
	...
	0x73, 0x73, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x3f, 0x0a, 0x16, 0x55, 0x70, 0x64, 0x61, 0x74,
	...
	0x6e, 0x73, 0x65, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x42, 0x39, 0x5a, 0x37, 0x67, 0x69, 0x74, 0x68,
...
var file_creation_methods_update_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_creation_methods_update_proto_goTypes = []any{
	(*UpdateCreationRequest)(nil),  // 0: creation.methods.UpdateCreationRequest
	(*UpdateCreationResponse)(nil), // 1: creation.methods.UpdateCreationResponse
	(*CreationUpdated)(nil),        // 2: creation.messages.CreationUpdated
...
var file_creation_methods_update_proto_depIdxs = []int32{
	2, // 0: creation.methods.UpdateCreationRequest.update_info:type_name -> creation.messages.CreationUpdated
	3, // 1: creation.methods.UpdateCreationRequest.access_token:type_name -> common.AccessToken
	4, // 2: creation.methods.UpdateCreationResponse.msg:type_name -> common.ApiResponse
